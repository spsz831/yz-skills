...
### 3.5 代表事件
≤30 字概括关键节点，含时间线更好。例：`2023.11被解雇5天回归;2025《温和奇点》;2026 Astra发布(10万GPU)`
...
### 3.8 英文名
能写就写；没有稳定英文名可留空或写拼音。注意人名拼写核对。

> **v0.3 变更说明**：「观点立场」「立场变化」两列已删除，表格从 13 列减为 11 列。相关内容已融入「代表事件」列。
