...
MAIN_ROWS = [
    [1, "奥特曼", "OpenAI之父","Sam Altman", "OpenAI CEO", "AI领军", "海外",
     "AGI加速+监管叙事并行", "2023谨慎叙事→2025《温和奇点》→2026宣称已跨越AGI门槛",
     "2023.11被解雇5天回归;2025《温和奇点》;2026 Astra发布(10万GPU);公开称已进入AGI时代",
     "X @sama;博客 samaltman.com", "高", ""],
    ...
    [6, "卡帕西", "","Andrej Karpathy", "Anthropic预训练团队负责人;前Tesla AI总监;OpenAI创始成员", "技术大神", "海外",
     "教育实用派+递归研究:用Claude加速预训练", "OpenAI创始成员→Tesla→Eureka Labs→2026.5加盟Anthropic",
     "LLM OS概念;2024创建Eureka Labs;2026.5加盟Anthropic组建递归研究团队",
     "X @karpathy;YouTube/博客", "高", ""],
    ...
    [33, "沙泽尔", "","Noam Shazeer", "OpenAI架构研究负责人;前Gemini联席负责人;Transformer作者", "技术大神", "海外",
     "技术信仰:规模化至上", "Transformer作者→创Character.AI→2024回归谷歌→2026.6加盟OpenAI",
     "2017《Attention Is All You Need》合著;2024带领Character.AI团队回归谷歌;2026.6官宣加入OpenAI任架构研究负责人",
     "(极少发声)技术访谈", "高", "2026年6月已从谷歌正式加盟OpenAI"],
    ...
    [85, "格雷格·布罗克曼", "", "Greg Brockman", "OpenAI联合创始人兼总裁", "AI领军", "海外",
     "工程务实派:算力+产品双线推进", "OpenAI创始成员→长期担任总裁→推动Astra发布",
     "2015 OpenAI创始;2023与奥特曼共同被解雇后回归;2026 Astra发布(史上最大规模训练)",
     "Stratechery深度访谈;OpenAI官方博客", "高", "OpenAI第二号人物,实际运营核心"],
    [86, "盛颖", "", "Ying Sheng", "RadixArk创始人;前xAI推理团队负责人", "AI领军", "海外",
     "开源 infra 平权派:让推理基础设施民主化", "LMSYS开源核心→xAI推理负责人→2026创立RadixArk",
     "SGLang开源推理引擎;RadixArk种子轮1亿美元;DeepSeek Day-0兼容",
     "X @sheng_ying;技术演讲", "高", "丈夫刘念民同在xAI;SGLang是业界主流推理引擎之一"],
    [87, "黄碧薇", "", "Biwei Huang", "Aether AI创始人;UCSD助理教授", "学者", "海外",
     "因果智能:下一代AI范式", "马普所→CMU博士→UCSD助理教授→2026创业",
     "Causation Transformer;Aether AI 2000万美元融资;世界模型+机器人",
     "学术演讲;CVPR展台", "中", "师从因果发现奠基人Clark Glymour,Bernhard Schölkopf"],
