...
MAIN_ROWS = [
    [1, '奥特曼', 'OpenAI之父', 'Sam Altman', 'OpenAI CEO', 'AI领军', '海外',
     '2023.11被解雇5天回归;2025《温和奇点》;2026 Astra发布(10万GPU);公开称已进入AGI时代', 'X @sama;博客 samaltman.com', '高', ''],
    ...
    [6, '卡帕西', '', 'Andrej Karpathy', 'Anthropic预训练团队负责人;前Tesla AI总监;OpenAI创始成员', '技术大神', '海外',
     'LLM OS概念;2024创建Eureka Labs;2026.5加盟Anthropic组建递归研究团队', 'X @karpathy;YouTube/博客', '高', ''],
    ...
    [33, '沙泽尔', '', 'Noam Shazeer', 'OpenAI架构研究负责人;前Gemini联席负责人;Transformer作者', '技术大神', '海外',
     '2017《Attention Is All You Need》合著;2024带领Character.AI团队回归谷歌;2026.6官宣加入OpenAI任架构研究负责人', '(极少发声)技术访谈', '高', '2026年6月已从谷歌正式加盟OpenAI'],
    ...
    [84, '玉伯', '', 'Yubo Wang', 'YouMind创始人;前阿里巴巴前端负责人(2008-2023)', 'AI领军', '国内',
     'Ant Design/AntV/语雀主导者;YouMind AI内容创作工具上线', '技术博客/演讲', '中', '本名王保平;中科大物理系;阿里15年,被誉为"阿里前端第一人"'],
    [85, '格雷格·布罗克曼', '', 'Greg Brockman', 'OpenAI联合创始人兼总裁', 'AI领军', '海外',
     '2015 OpenAI创始;2023与奥特曼共同被解雇后回归;2026 Astra发布(史上最大规模训练)', 'Stratechery深度访谈;OpenAI官方博客', '高', 'OpenAI第二号人物,实际运营核心'],
    [86, '盛颖', '', 'Ying Sheng', 'RadixArk创始人;前xAI推理团队负责人', 'AI领军', '海外',
     'SGLang开源推理引擎;RadixArk种子轮1亿美元;DeepSeek Day-0兼容', 'X @sheng_ying;技术演讲', '高', '丈夫刘念民同在xAI;SGLang是业界主流推理引擎之一'],
    [87, '黄碧薇', '', 'Biwei Huang', 'Aether AI创始人;UCSD助理教授', '学者', '海外',
     'Causation Transformer;Aether AI 2000万美元融资;世界模型+机器人', '学术演讲;CVPR展台', '中', '师从因果发现奠基人Clark Glymour,Bernhard Schölkopf'],
]
...
def main():
    ...
    main_align = {1: "center", 2: "center", 3: "center", 5: "center", 6: "center", 9: "center"}  # 1=序号,2=姓名,3=外号,5=圈层,6=国别,9=关注优先级
    main_xml = build_sheet(
        MAIN_TITLE, MAIN_HEADERS, MAIN_ROWS, main_align,
        widths=[6, 10, 8, 16, 30, 11, 8, 34, 20, 9, 26],
        formula_col=None,
        formula_fn=None,
        row_ht=28,
        data_validations=[
